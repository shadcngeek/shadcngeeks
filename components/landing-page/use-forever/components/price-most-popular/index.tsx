...
export function PriceMostPopular() {
  return (
    <Card className="w-[350px] relative bg-transparent dark:bg-transparent">
      <div className="absolute px-[24px] top-0 left-[50%] translate-x-[-50%] translate-y-[-50%] text-sm py-[12px] bg-slate-900 dark:bg-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white dark:text-slate-900 rounded-full">
        Most Popular
      </div>
      <CardHeader>
