      ...
      <div className="mx-auto w-fit p-4 sm:p-10">
        <div className="relative w-[300px] h-[300px] border-4 rounded-full border-slate-950 dark:border-white">
          <div
            ...
            className="w-1 h-[70px] bg-slate-950 dark:bg-white absolute origin-bottom top-[26%] left-[50%] translate-x-[-50%] rotate-4"
          ></div>
          <div
            style={{
              transform: `rotateZ(${time.getMinutes() * 6}deg)`,
            }}
            className="w-1 h-[100px] bg-slate-950 dark:bg-white absolute origin-bottom top-[16%] left-[50%] translate-x-[-50%] rotate-45"
          ></div>
          <div
            style={{
