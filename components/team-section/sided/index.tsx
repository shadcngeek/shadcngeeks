...
function TeamSided() {
  return (
    <Card>
      <CardContent className="p-4 md:p-10 lg:p-14">
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="space-y-2 max-w-[700px] xl:w-full lg:w-[500px] shrink pr-10 lg:border-r dark:border-slate-800">
          ...
          <div className="lg:ml-10 shrink-0 mx-auto mt-5 md:mt-10 lg:mt-0 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5 xl:gap-10">
