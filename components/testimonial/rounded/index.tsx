...
function RoundedTestimonial() {
  return (
    <div className="w-full h-dvh flex items-center justify-center dark:bg-slate-950">
      <div>
        <p className="text-7xl dark:text-white text-center font-semibold mb-5">
          Testimonials
        </p>
        <div className="relative w-[650px] h-[650px] rounded-full">
          <div className="absolute z-30 w-[300px] h-[300px] top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%]">
            <div className="relative h-[300px] rounded-full w-[300px] flex justify-center items-center">
              <Quote
