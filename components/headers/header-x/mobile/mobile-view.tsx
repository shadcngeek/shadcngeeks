...
import { components, listLinkData } from "../data/data";
    ...
    <Sheet>
      ...
      <SheetContent side={"left"} className="p-4 md:p-6 dark:border-slate-800">
        <NavigationMenu className="!max-w-full justify-start [&>div]:w-full">
          <NavigationMenuList className="flex-col gap-3 text-slate-700 items-start !flex-1 !w-full">
            <NavigationMenuItem className="w-full flex-1">
              <NavigationMenuTrigger className="dark:text-slate-400 w-full justify-start">
                Getting started
              </NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul className="grid gap-3 p-6 md:sm:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
